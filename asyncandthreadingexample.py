...
#get_data_sync(urls) #50
#get_data_threading(urls) #4.87
#asyncio.run(get_data_async_but_as_wrapper(urls)) #34
#asyncio.run(get_data_async_concurrently(urls)) #3.38
